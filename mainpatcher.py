...
async def cmd_start(message: Message):
    ...
    await message.answer(
        "Сратьжпт 4бот приветствует вас\. Адай деньги\.",
    )
...
async def message_with_text(message: Message):
    ...
    try:
        ...
        respon = str(respond(m3 + message.text + m2 + hystory).text)
